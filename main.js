function calcular (){
    ...
    let horaIni = parseInt(document.getElementById('horaIni').value.trim());
    let minIni = parseInt(document.getElementById('minIni').value.trim());
    let horaFim = parseInt(document.getElementById('horaFim').value.trim());
    let minFim = parseInt(document.getElementById('minFim').value.trim());

    // validação de entrada
    if (
        isNaN(horaIni)|| isNaN(horaFim) ||
        isNaN(minIni) || isNaN(minFim) ||
